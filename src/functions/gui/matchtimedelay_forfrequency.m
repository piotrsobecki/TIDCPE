function varargout = matchtimedelay_forfrequency(varargin)
...
% Last Modified by GUIDE v2.5 21-Sep-2015 19:18:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @matchtimedelay_forfrequency_OpeningFcn, ...
                   'gui_OutputFcn',  @matchtimedelay_forfrequency_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function matchtimedelay_forfrequency_OpeningFcn(hObject, eventdata, handles, varargin)
...
handles.analysisConfig.plot_title = sprintf('%s and %s vectorised cross correlation', y1_title, y2_title);

set(gcf, 'name', handles.analysisConfig.plot_title);
scalogram2d_func(handles.dataConfig, handles.analysisConfig,handles);

params_str = stringify_params( handles.dataConfig, handles.analysisConfig,['fileName','interp_fsample','tmin','tmax','cLevels','Bo','omega_0']);
...
function varargout = matchtimedelay_forfrequency_OutputFcn(hObject, eventdata, handles)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
matchtimedelay_forfrequency_func(handles.dataConfig, handles.analysisConfig,handles);
