function varargout = wavelet_bicoherence(varargin)
...
% Last Modified by GUIDE v2.5 17-Aug-2015 00:31:35
...
wavelet_bicoherence_func( dataConfig,analysisConfig,handles);
params_str = stringify_params(dataConfig,analysisConfig,['fileName','tmin','tmax','interp_fsample','cLevels','Bo','omega_0','tN','sN']);
